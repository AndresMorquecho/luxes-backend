 ...
 */
export function safeResolvePath(baseDir, ...subPaths) {
 ...
 */
export async function safeRemoveDir(baseDir, targetSubDir) {
 ...
 */
export async function safeUnlinkFile(baseDir, fileRelativeOrUrlPath) {
    if (!fileRelativeOrUrlPath || typeof fileRelativeOrUrlPath !== 'string')
        return;
    const resolvedBase = path.resolve(baseDir);
