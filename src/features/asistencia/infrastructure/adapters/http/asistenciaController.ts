...
export class AsistenciaController {
  ...
  async eliminarPermiso(req: Request, res: Response): Promise<Response> {
    try {
  ...
  async getAutoAsistenciaStatus(req: Request, res: Response): Promise<Response> {
    try {
      const empleadoId = String(req.params.empleadoId);
  ...
  async toggleAutoAsistenciaStatus(req: Request, res: Response): Promise<Response> {
    try {
      const empleadoId = String(req.params.empleadoId);
