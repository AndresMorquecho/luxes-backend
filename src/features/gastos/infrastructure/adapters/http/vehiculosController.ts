...
function parseFechaMantenimiento(fechaInput: any): Date {
...
export class VehiculosController {
  ...
  async uploadControlFoto(req: Request, res: Response): Promise<Response> {
    try {
  ...
  async createControl(req: Request, res: Response): Promise<Response> {
    try {
      ...
      const parseFechaControl = (val?: string): Date => {
  ...
  async updateControl(req: Request, res: Response): Promise<Response> {
    try {
      ...
      if (b.fecha !== undefined) updateData.fecha = parseFechaControl(b.fecha);
      if (b.kilometraje !== undefined) updateData.kilometraje = Number(b.kilometraje);
      if (b.combustible !== undefined) updateData.combustible = String(b.combustible);
      if (b.nivelAceite !== undefined) updateData.nivelAceite = Boolean(b.nivelAceite);
      if (b.nivelAgua !== undefined) updateData.nivelAgua = Boolean(b.nivelAgua);
      if (b.aceiteHidraulico !== undefined) updateData.aceiteHidraulico = Boolean(b.aceiteHidraulico);
      if (b.liquidoFrenos !== undefined) updateData.liquidoFrenos = Boolean(b.liquidoFrenos);
      if (b.gataLlave !== undefined) updateData.gataLlave = Boolean(b.gataLlave);
      if (b.extintorBotiquin !== undefined) updateData.extintorBotiquin = Boolean(b.extintorBotiquin);
      if (b.bandas !== undefined) updateData.bandas = Boolean(b.bandas);
      if (b.otroCheckNombre !== undefined) updateData.otroCheckNombre = String(b.otroCheckNombre ?? '');
      if (b.otroCheckValor !== undefined) updateData.otroCheckValor = Boolean(b.otroCheckValor);
      if (b.observacion !== undefined) updateData.observacion = String(b.observacion ?? '');
      if (b.sugerencia !== undefined) updateData.sugerencia = String(b.sugerencia ?? '');

      if (b.fotoGasolinaInicio !== undefined) updateData.fotoGasolinaInicio = b.fotoGasolinaInicio ? String(b.fotoGasolinaInicio) : null;
      if (b.fotoKmInicio !== undefined) updateData.fotoKmInicio = b.fotoKmInicio ? String(b.fotoKmInicio) : null;
      if (b.fotoKmFin !== undefined) updateData.fotoKmFin = b.fotoKmFin ? String(b.fotoKmFin) : null;
      if (b.fotoGasolinaFin !== undefined) updateData.fotoGasolinaFin = b.fotoGasolinaFin ? String(b.fotoGasolinaFin) : null;
  ...
  async removeControl(req: Request, res: Response): Promise<Response> {
    try {
      const { controlId } = req.params;
