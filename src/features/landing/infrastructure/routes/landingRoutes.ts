...
import {
  ...
  LandingController,
  UPLOADS_DIR,
} from '../adapters/http/landingController.js';
...
const handleUploadError = (upload: ReturnType<typeof multer>) =>
...
export function createLandingRoutes(): Router {
  const router = Router();
  ...
  router.delete(
    '/images/:section/:itemId',
    ...adminMiddleware,
    (req, res) => landingController.resetImage(req, res)
  );
  ...
  router.put(
    '/whatsapp',
    ...adminMiddleware,
    (req, res) => landingController.updateWhatsapp(req, res)
  );
  ...
  router.put(
    '/social',
    ...adminMiddleware,
    (req, res) => landingController.updateSocial(req, res)
  );
  ...
  router.post(
    '/categories',
    ...adminMiddleware,
    (req, res) => landingController.createCategory(req, res)
  );

  router.put(
    '/categories/:id',
    ...adminMiddleware,
    (req, res) => landingController.updateCategory(req, res)
  );

  router.delete(
    '/categories/:id',
    ...adminMiddleware,
    (req, res) => landingController.deleteCategory(req, res)
  );
  ...
  router.post(
    ...
    ...adminMiddleware,
    handleUploadError(upload),
    (req, res) => landingController.addCategoryImage(req, res)
  );

  router.patch(
    '/categories/images/:imageId',
    ...adminMiddleware,
    (req, res) => landingController.updateCategoryImage(req, res)
  );

  router.delete(
    '/categories/images/:imageId',
    ...adminMiddleware,
    (req, res) => landingController.deleteCategoryImage(req, res)
  );
