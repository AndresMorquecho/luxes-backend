/**
 * fix-otros-ingresos.js - Script one-shot para corregir en la BD los registros
 * de nómina con ingresos OTROS sin el campo otrosIngresos en el JSON.
 * Ejecutar: node src/fix-otros-ingresos.js
 */
